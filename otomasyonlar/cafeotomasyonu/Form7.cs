...
namespace cafeotomasyonu
{
    public partial class Form7 : Form
    {
        ...
        private void button3_Click_1(object sender, EventArgs e)
        {
            ...
            frm1.bag.Close();
            frm1.dtst.Clear();
            frm1.frm2.button6.BackColor = System.Drawing.Color.Red;
        }
        ...
        {
            frm1.frm13.label3.Text = frm1.frm7.comboBox1.Text;
            frm1.frm13.label4.Text = frm1.frm7.comboBox2.Text;
            frm1.frm13.label5.Text = frm1.frm7.comboBox3.Text;
            frm1.frm13.label6.Text = frm1.frm7.comboBox4.Text;
            frm1.frm13.Show();
            this.Hide();
            frm1.frm13.label1.Text = "5";
        }
