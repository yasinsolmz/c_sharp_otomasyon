...
namespace cafeotomasyonu
{
    public partial class Form4 : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            frm1.bag.Close();
            frm1.dtst.Clear();
            frm1.frm2.button3.BackColor = System.Drawing.Color.Red;
        }
        ...
        {
            frm1.frm13.label3.Text = frm1.frm4.comboBox1.Text;
            frm1.frm13.label4.Text = frm1.frm4.comboBox2.Text;
            frm1.frm13.label5.Text = frm1.frm4.comboBox3.Text;
            frm1.frm13.label6.Text = frm1.frm4.comboBox4.Text;
            frm1.frm13.Show();
            this.Hide();
            frm1.frm13.label1.Text = "2";
        }
