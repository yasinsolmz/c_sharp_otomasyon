...
namespace cafeotomasyonu
{
    public partial class Form8 : Form
    {
        ...
        private void button3_Click_1(object sender, EventArgs e)
        {
            ...
            frm1.bag.Close();
            frm1.dtst.Clear();
            frm1.frm2.button7.BackColor = System.Drawing.Color.Red;
        }
        ...
        {
            frm1.frm13.label3.Text = frm1.frm8.comboBox1.Text;
            frm1.frm13.label4.Text = frm1.frm8.comboBox2.Text;
            frm1.frm13.label5.Text = frm1.frm8.comboBox3.Text;
            frm1.frm13.label6.Text = frm1.frm8.comboBox4.Text;
            frm1.frm13.Show();
            this.Hide();
            frm1.frm13.label1.Text = "6";
        }
